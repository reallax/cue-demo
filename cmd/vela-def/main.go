...
func main() {
	...
	if err := value.AddFile(bi, "-", renderTemplate(webserviceTemplate)); err != nil {
		return
	}
	...
	if err := value.AddFile(bi, "parameter", paramFile); err != nil {
		return
	}
	...
	output := val.LookupPath(value.FieldPath("output"))
	fmt.Printf("##output:\n%# v\n", output.Eval())

	outputs := val.LookupPath(value.FieldPath("outputs"))
	fmt.Printf("##outputs:\n%# v\n", outputs.Eval())
}

// simplify github.com/kubevela/workflow/pkg/tasks/custom.MakeBasicValue
// func mockMakeBasicValue(parameterTemplate string) {
// 	paramStr := "parameter: {}\n"
...
// func getDemoApp() *oamcore.Application {
// 	namespaceName := "paas-dev"
...
// 			Name:      "symphony-aabb-1",
// 			Namespace: namespaceName,
// 			Annotations: map[string]string{
// 				"app.oam.dev/appName": "symphony-aabb-1",
// 			},
...
// 					Name:       "symphony-aabb-1",
// 					Type:       "webservice",
// 					Properties: &runtime.RawExtension{Raw: []byte(`{"nameSuffix":"blue","cpu":"0.5","env":{"name":"APP_CODE","value":"it-symphony-aabb006"},"exposeType":"ClusterIP","image":"dmall-bj.tencentcloudcr.com/mid-rd/it-symphnony-aabb006:v3","imagePullPolicy":"IfNotPresent","imagePullSecrets":["dmallbj"],"memory":"1024Mi"}`)},
// 					Inputs: workflowv1alpha1.StepInputs{
// 						{
// 							From:         "message",
// 							ParameterKey: "properties.image",
// 						},
// 						{
// 							From:         "message",
// 							ParameterKey: "properties.exposeType",
// 						},
// 					},
...
// 					Name: "override-blue",
// 					Type: "override",
// 					Properties: &runtime.RawExtension{Raw: []byte(`{"components":[{"type":"webservice","properties":{"nameSuffix":"blue","memory":"1004Mi"},"traits":[{"type":"scaler","properties":{"replicas":1}}]}]}`)},
// 				},
// 				{
// 					Name: "override-green",
// 					Type: "override",
// 					Properties: &runtime.RawExtension{Raw: []byte(`{"components":[{"type":"webservice","properties":{"nameSuffix":"green","memory":"1008Mi"},"traits":[{"type":"scaler","properties":{"replicas":2}}]}]}`)},
// 				},
// 			},
...
// 							Name: "deploy-blue",
// 							Type: "deploy",
// 							Properties: &runtime.RawExtension{Raw: []byte(`{"policies":["override-blue"]}`)},
// 						},
// 					},
// 					{
// 						WorkflowStepBase: workflowv1alpha1.WorkflowStepBase{
// 							Name: "deploy-green",
// 							Type: "deploy",
// 							Properties: &runtime.RawExtension{Raw: []byte(`{"policies":["override-green"]}`)},
// 						},
// 					},
// 				},
// 			},
...
const webserviceTemplate = ` import (
    "strconv"
    "strings"
)
